...
python -c "from src.utilities.platform_utils import detect_wsl2, get_wsl2_compatibility_warnings; print('WSL2:', detect_wsl2()); [print(w) for w in get_wsl2_compatibility_warnings()]"
...
python -c "from src.utilities.platform_utils import show_platform_info; show_platform_info()"
```
